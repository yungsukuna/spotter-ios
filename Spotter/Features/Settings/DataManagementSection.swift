...
struct DataManagementSection: View {
    ...
    @State private var pendingImport: SpotterBackup?
    ...
    private func handlePickedFile(_ result: Result<URL, Error>) {
        ...
        case .success(let url):
            ...
            do {
                ...
                let backup = try BackupCoding.makeDecoder().decode(SpotterBackup.self, from: data)
    ...
    private static func friendlyMessage(for error: Error) -> String {
        ...
        if error is DecodingError {
            return BackupError.decodingFailed.errorDescription ?? "This file doesn't look like a Spotter backup."
        }
