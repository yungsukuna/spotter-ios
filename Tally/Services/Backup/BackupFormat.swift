...
struct TallyBackup: Codable, Sendable {
...
enum BackupError: Error, LocalizedError, Sendable {
    ...
    var errorDescription: String? {
        ...
        case .unsupportedVersion(let found, let supported):
            return "This backup file (format \(found)) was made by a newer version of Tally. This version supports up to format \(supported)."
        case .decodingFailed:
            return "This file doesn't look like a Tally backup."
        case .fileReadFailed:
